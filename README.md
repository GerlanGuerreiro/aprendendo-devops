...
**Gerlan Guerreiro Damasceno** · Manaus, AM · [GitHub](https://github.com/GerlanGuerreiro)
...
Ponto de partida: Python avançado, Shell Script, Java, C e Linux — a trilha constrói DevOps sobre essa base.
